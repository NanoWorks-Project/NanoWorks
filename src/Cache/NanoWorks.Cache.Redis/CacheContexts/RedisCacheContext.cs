...
namespace NanoWorks.Cache.Redis.CacheContexts
{
    ...
    {
        private readonly CacheContextOptions _options;
        ...
        public RedisCacheContext(CacheContextOptions options)
        {
            _options = options;
        }
        ...
        public CacheSet<TItem, TKey> NewSet<TItem, TKey>(Action<CashSetOptions<TItem, TKey>> configure)
