...
/// </summary>
public class RedisCashSetOptions
{
    /// <summary>
...
public sealed class RedisCashSetOptions<TItem, TKey> : RedisCashSetOptions
    where TItem : class, new()
{
    ...
    public RedisCashSetOptions<TItem, TKey> Table(string tableName)
    {
        TableName = tableName;
        return this;
    }
    ...
    public RedisCashSetOptions<TItem, TKey> Key(Func<TItem, TKey> keySelector)
    {
    ...
    public RedisCashSetOptions<TItem, TKey> Expiration(TimeSpan expirationDuration)
    {
